...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
  ...
  <div class="relative bg-[#FFFFFF] rounded-xl border-[6px] border-[#F9E2AF] shadow-lg w-full max-w-sm p-6">
    ...
    <!-- Tombol Close (X) -->
    <a href="/berandaSebelumLogin" class="absolute top-4 right-4 text-gray-500 hover:text-gray-700 text-2xl font-bold">&times;</a>
...
<?php /**PATH C:\Users\User\Cooknice2\resources\views/daftar.blade.php ENDPATH**/ ?>