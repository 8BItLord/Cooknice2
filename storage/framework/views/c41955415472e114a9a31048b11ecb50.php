<aside class="bg-white flex-shrink-0 rounded-md m-2 mr-1 border shadow-lg transition-all duration-300 md:w-64 sm:w-20 flex flex-col items-center py-6">
        ...
        <nav class="flex flex-col space-y-4 w-full px-4">
          <!-- Item -->
          <a href="/" class="<?php echo e(request()->is('/') ? 'bg-[#F58E4A] text-white hover:text-black' : 'text-black rounded-xl hover:bg-[#D9D9D9]'); ?> flex items-center space-x-4 px-4 py-3 rounded-xl hover:bg-[#D9D9D9] transition-all duration-300">
